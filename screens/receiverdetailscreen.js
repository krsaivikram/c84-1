...
import {Cards,Icon,Header} from 'react-native-elements'
export default class ReceiverDetails extends Component{
    ...
    addnotification =()=>{
        var notification = this.state.emailid+"has shown interest in donating a book"
       ...
       return(
           ...
           <View style={{flex:0.3}}>
            ...
            <View style={styles.buttonContainer}>
                {this.state.receiverid !== this.state.emailid?(<TouchableOpacity onPress={()=>{
